! function(t, e) {
   ...
   var p = t(function(t, e) {
      ...
      y = (p.polyfill, function(t) {
         function i() {
            var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return s(this, i), t = c(this, l(i).call(this, e)), p.polyfill(), window.addEventListener("scroll", t.checkScroll, !1), t
         }
         return e(i, d), o(i, [{
            key: "init",
            value: function() {
               this.instance.scroll.y = window.pageYOffset, this.addElements(), this.detectElements(), h(l(i.prototype), "init", this).call(this)
            }
         }, {
            key: "checkScroll",
            value: function() {
               var t = this;
               h(l(i.prototype), "checkScroll", this).call(this), this.instance.scroll.y = window.pageYOffset, this.els.length && (this.hasScrollTicking || (requestAnimationFrame(function() {
                  t.detectElements()
            ...
            value: function() {
               ...
               this.els = [], this.el.querySelectorAll("[data-" + this.name + "]").forEach(function(t, e) {
                  var i = t.dataset[c.name + "Class"] || c.class,
                     ...
                     n = s + t.offsetHeight,
                     o = parseInt(t.dataset[c.name + "Offset"]) || parseInt(c.offset),
                     l = t.dataset[c.name + "Repeat"],
                     r = t.dataset[c.name + "Call"],
                     a = {
                        el: t,
                        id: e,
                        class: i,
                        ...
                        bottom: n,
                        offset: o,
                        repeat: l = "false" != l && (null != l || c.repeat),
                        inView: !1,
                        call: r
                     };
                  c.els.push(a)
            ...
            value: function(t, e) {
               ...
               "string" == typeof t ? "top" === t ? i = this.html : "bottom" === t ? s = this.html.offsetHeight - window.innerHeight : i = document.querySelectorAll(t)[0] : t.target || (i = t), i && (s = i.getBoundingClientRect().top + s), s += this.instance.scroll.y, window.scrollTo({
                  top: s,
                  behavior: "smooth"
               })
            }
            ...
            key: "destroy",
            value: function() {
               h(l(i.prototype), "destroy", this).call(this), window.removeEventListener("scroll", this.checkScroll, !1)
            }
         }]), i
      }()),
   ...
   var b = function() {
      ...
      for (var i, s, n = function(t) {
         ...
         for (var l in i = Object(arguments[o])) m.call(i, l) && (n[l] = i[l]);
         if (v) {
            s = v(i);
            for (var r = 0; r < s.length; r++) g.call(i, s[r]) && (n[s[r]] = i[s[r]])
         }
      }
      return n
   };
   ...
   function Y(t) {
      ! function(t) {
         ...
         if (0 === e.length)
            for (var i in t) O.call(t, i) && "function" == typeof t[i] && "[object Function]" == T.call(t[i]) && e.push(i);
         for (var s = 0; s < e.length; s++) {
            var n = e[s];
            t[n] = L(t[n], t)
         }
      }(this, "_onWheel", "_onMouseWheel", "_onTouchStart", "_onTouchMove", "_onKeyDown"), this.el = window, t && t.el && (this.el = t.el, delete t.el), this.options = b({
         mouseMultiplier: 1,
         touchMultiplier: 2,
         ...
         limitInertia: !1,
         useKeyboard: !0
      }, t), this.options.limitInertia && (this._lethargy = new _), this._emitter = new S, this._event = {
         y: 0,
         x: 0,
         deltaX: 0,
         deltaY: 0
   ...
   var R = 38,
      ...
      W = function(t) {
         function n() {
            var t, e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
            return s(this, n), (t = c(this, l(n).call(this, e))).inertia = .1 * t.inertia, t.isScrolling = !1, t.isDraggingScrollbar = !1, t.isTicking = !1, t.hasScrollTicking = !1, t.parallaxElements = [], t.inertiaRatio = 1, t.stop = !1, t.checkKey = t.checkKey.bind(a(t)), window.addEventListener("keydown", t.checkKey, !1), t
         }
         return e(n, d), o(n, [{
            key: "init",
            value: function() {
               ...
               }), this.setScrollLimit(), this.initScrollBar(), this.addSections(), this.addElements(), this.detectElements(), this.transformElements(!0), h(l(n.prototype), "init", this).call(this)
            }
         }, {
            key: "setScrollLimit",
            value: function() {
            ...
            value: function() {
               ...
               if (this.isScrolling || this.isDraggingScrollbar) {
                  ...
                  this.transform(this.scrollbarThumb, 0, s), h(l(n.prototype), "checkScroll", this).call(this), this.hasScrollTicking = !1
               }
            }
         }, {
            key: "checkResize",
            ...
            key: "updateScroll",
            value: function(t) {
               this.isScrolling || this.isDraggingScrollbar ? this.instance.scroll.y = P(this.instance.scroll.y, this.instance.delta.y, this.inertia * this.inertiaRatio) : this.instance.scroll.y = this.instance.delta.y
            }
         }, {
            key: "addDirection",
            value: function() {
            ...
            value: function() {
               ...
               this.els = [], this.parallaxElements = [], this.sections.forEach(function(t, b) {
                  w.sections[b].el.querySelectorAll("[data-".concat(w.name, "]")).forEach(function(t, e) {
                     ...
                     var p = (i = w.sections[b].inView ? s.getBoundingClientRect().top + w.instance.scroll.y - X(s).y : s.getBoundingClientRect().top - X(w.sections[b].el).y - X(s).y) + s.offsetHeight,
                        y = (p - i) / 2 + i;
                     if (h) {
            ...
            value: function() {
               ...
               0 === t.length && (t = [this.el]), t.forEach(function(t, e) {
                  var i = t.getBoundingClientRect().top - 1.5 * window.innerHeight - X(t).y,
                     ...
                     o = !1;
                  r.instance.scroll.y >= i && r.instance.scroll.y <= s && (o = !0);
                  var l = {
                     el: t,
                     offset: i,
                     limit: s,
            ...
            key: "destroy",
            value: function() {
               h(l(n.prototype), "destroy", this).call(this), this.stopScrolling(), this.html.classList.remove(this.smoothClass), this.vs.destroy(), this.destroyScrollBar(), window.removeEventListener("keydown", this.checkKey, !1)
            }
         }]), n
      }();
   return function() {
      ...
      return o(e, [{
         key: "init",
         value: function() {
            this.smoothMobile || (this.isMobile = /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)), !0 !== this.smooth || this.isMobile ? this.scroll = new y(this.options) : this.scroll = new W(this.options), this.scroll.init(), window.location.hash && this.scroll.scrollTo(window.location.hash)
         }
      }, {
         key: "update",
         value: function() {
